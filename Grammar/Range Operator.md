...
# 1. 범위 연산자
## 1-1. 닫힌 범위 연산자(Closed Range Operator) : 시작과 끝이 정해져 있는 범위 연산자(점 세개를 표시) a…b a이상 b이하

## 1-2. 반 닫힌 범위 연산자(Half-Open Range Operator) : 시작과 끝이 정해져 있는 범위 연산자 a..<b a이상 b미만
